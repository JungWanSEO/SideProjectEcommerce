...
> **2026-07-21 기준: instruction 86.6% · branch 74.0% (542 tests)**
> 이력: 82.6%(07-14 도입) → 84.5%(0% 구멍 메움) → **86.6%(분기 보강)**.
> 최근 보강: PaymentService 64→94.7%(부분환불)·MemberCouponService 66.9→80.7%·activity/recommendation/wishlist 컨트롤러 0→100%.
